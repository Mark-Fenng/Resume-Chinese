...
% Command for entering a new project
\newcommand{\projectentry}[6]{
	{\large{\textbf{#1}}} \hfill \textsc{#2} % Project name and duration
	\begin{itemize}
		\item \textbf{项目主页：}\href{#3}{#4} % Project home page
		\item \textbf{项目简介：}{#5} % Project description
		\item \textbf{主要职责：}{#6} % Duty in the project		
	\end{itemize}
}
...
\newcommand{\educationentry}[5]{
	...
	\expandafter\ifstrequal\expandafter{#4}{}{}{& \small{#4}\\} % Department
